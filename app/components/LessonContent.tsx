...
const LessonContent: React.FC<LessonContentProps> = ({ lesson }) => {
  ...
  const [submissionResult, setSubmissionResult] = useState<{message: string; isCorrect: boolean} | null>(null);
  ...
  const submitExercise = async () => {
    ...
    try {
      ...
      setSubmissionResult({ message: 'Error checking exercise. Please try again.', isCorrect: false });
    } finally {
  ...
  return (
    <div className="flex flex-1">
      ...
      <div className="w-1/2 bg-gray-800 p-4 text-white">
        ...
        {submissionResult && (
          <div className={`mt-4 p-2 rounded ${submissionResult.isCorrect ? 'bg-green-700' : 'bg-red-700'}`}>
      ...
      {showAssistant && (
        <div className="right-0 top-0 h-full w-1/3 bg-gray-700 p-4 shadow-lg overflow-y-auto ">
